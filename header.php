    ...
    <div class="card-deck" style="margin-top:1vh;margin-left:4vw;margin-right:4vw;margin-bottom:1vh;overflow-x:hidden;">
    	<div class="card" style="background-color: #ffa31a;margin-right:2vw" data-aos="fade-right">
    		<div class="card-body text-center" style="padding-top:4vw;">
    			...
    			<a href="article.php" class="btn btn-primary custom-button stretched-link">More</a>
    		</div>
    	</div>
    	...
    	<div class="card" style="background-color: #ffa31a;" data-aos="fade-left">
    		<div class="card-body text-center" style="padding-top:4vw;">
    			...
    			<a href="login.php" class="btn btn-primary custom-button stretched-link">More</a>
    		</div>
    	</div>
    </div>
    <br><br><br><br><br>
...
?>
    ...
    <div class="container">
      <a href="register.php">
    		<div class="jumbotron text-center joinus">
        	<h1 class="joinus-text">Join Us!</h1>
        	<p class="joinus-message">And post your own food reviews</p>
      	</div>
    	</a>
    </div>
    <br><br><br><br><br>
